import { ConflictException, notfoundexception as NotFoundException, badrequestexception as BadRequestException, } from "../common/exceptions/domain.exceptions.js";
...
class AuthService {
    ...
    async logout(refreshToken) {
        try {
            const decoded = this._tokenService.decodeToken({ token: refreshToken });
